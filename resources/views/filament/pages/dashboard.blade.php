                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">
                            Selamat Datang di Panel Admin PMII
                        </h2>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Kelola data anggota, user, dan administrasi sistem secara terpusat. 
                ...
                <div class="fi-section-content-ctn px-6 py-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                Kelola database anggota, import/export Excel
                            </p>
                        </div>
                    </div>
                </div>
